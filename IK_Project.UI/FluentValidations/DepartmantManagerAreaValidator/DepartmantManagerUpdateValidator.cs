...
namespace IK_Project.UI.FluentValidations.DepartmantManagerAreaValidator
{
    public class DepartmantManagerUpdateValidator : AbstractValidator<DepartmantManagerUpdateVM>
    {
