...
{
    public class DepartmantManagerPermissionCreateValidator : AbstractValidator<DepartmantManagerPermissionCreateVM>
    {
        public DepartmantManagerPermissionCreateValidator()
        {
