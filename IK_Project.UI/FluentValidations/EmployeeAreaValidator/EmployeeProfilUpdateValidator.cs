...
namespace IK_Project.UI.FluentValidations.EmployeeAreaValidator
{
    public class EmployeeProfilUpdateValidator : AbstractValidator<EmployeeVM>
    {
        public EmployeeProfilUpdateValidator()
        {
            RuleFor(x => x.Name)
