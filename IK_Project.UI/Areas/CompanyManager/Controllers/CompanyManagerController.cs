...
{
    public class CompanyManagerController : CompanyManagerBaseController
    {
        ...
        public CompanyManagerController(ICompanyManagerService companyManagerService, IMapper mapper, IWebHostEnvironment webHostEnvironment, ICompanyService companyService, UserManager<IdentityUser> userManager, IEMailSenderService emailSender, SignInManager<IdentityUser> signInManager)
        {
