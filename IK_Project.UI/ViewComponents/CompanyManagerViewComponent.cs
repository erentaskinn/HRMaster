...
{
    public class CompanyManagerViewComponent : ViewComponent
    {
        ICompanyManagerService _cmService;
        IMapper _mapper;
        private readonly SignInManager<AppUser> _signInManager;
        private readonly UserManager<AppUser> _userManager;


        public CompanyManagerViewComponent(ICompanyManagerService cmService, IMapper mapper, SignInManager<AppUser> signInManager, UserManager<AppUser> userManager)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            if (_signInManager.IsSignedIn(HttpContext.User))
            {
                ...
                //List<CompanyManagerListVM> cmVm = _mapper.Map<List<CompanyManagerListVM>>(await _cmService.GetDefaults(x => x.AppUser.UserName == HttpContext.User.Identity.Name));
